...
<?php /* canonicalは有効化済みのcanonicalプラグイン(siteHead)が出力する。
         テーマ側でも出すと二重になるため削除(2026-07-14 SEO監査)。 */ ?>
...
<?php /* sitemapプラグイン無効でTheme::sitemapUrl()が空だったため、
         blog_post.pyが生成する静的sitemap.xmlを直接指す(2026-07-14)。 */ ?>
<link rel="sitemap" type="application/xml" href="<?php echo DOMAIN_BASE; ?>sitemap.xml">

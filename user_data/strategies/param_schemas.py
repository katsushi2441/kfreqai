...
SCHEMAS = {
    ...
    "KfreqaiMeanRevStrategy": [
        {"key": "trend_sma", "type": "int", "default": 200, "min": 20, "max": 400, "step": 5,
         "group": "trend", "label": {"ja": "トレンドSMA期間", "en": "Trend SMA period"}},
        {"key": "use_trend_filter", "type": "bool", "default": True,
         "group": "trend", "label": {"ja": "上昇トレンドのみ買う", "en": "Only buy in uptrend"}},
        {"key": "rsi_period", "type": "int", "default": 14, "min": 2, "max": 50, "step": 1,
         "group": "entry", "label": {"ja": "RSI期間", "en": "RSI period"}},
        {"key": "rsi_buy", "type": "float", "default": 30.0, "min": 5.0, "max": 50.0, "step": 1.0,
         "group": "entry", "label": {"ja": "押し目買いRSI(未満で買い)", "en": "Buy when RSI below"}},
        {"key": "rsi_sell", "type": "float", "default": 65.0, "min": 40.0, "max": 95.0, "step": 1.0,
         "group": "exit", "label": {"ja": "反発決済RSI(超で売り)", "en": "Sell when RSI above"}},
        {"key": "tp_pct", "type": "float", "default": 10.0, "min": 0.5, "max": 50.0, "step": 0.5,
         "group": "exit", "label": {"ja": "利確(%)", "en": "Take-profit (%)"}},
        {"key": "stoploss_pct", "type": "float", "default": -10.0, "min": -50.0, "max": -0.5, "step": 0.5,
         "group": "risk", "label": {"ja": "ストップロス(%)", "en": "Stop-loss (%)"}},
        {"key": "min_hold_min", "type": "int", "default": 0, "min": 0, "max": 1440, "step": 5,
         "group": "risk", "label": {"ja": "最小保有(分)", "en": "Min hold (min)"}},
        {"key": "reentry_cooldown_min", "type": "int", "default": 0, "min": 0, "max": 1440, "step": 5,
